...
import com.bytmasoft.sms.model.StudentsModel;
...
public class DashboardController {
	...
	@FXML
	private LineChart<StudentsModel, ?> lineChart;

	@FXML
	private BubbleChart<StudentsModel, ?> bubbleChart;
	...
	private ObservableList<StudentsModel> studentsModels = FXCollections.observableArrayList(
			new StudentsModel(1, "Amos", "Chepchieng"), new StudentsModel(2, "Amos", "Mors"),
			new StudentsModel(3, "Amos", "Chepchieng"), new StudentsModel(4, "Amos", "Mors"),
			new StudentsModel(5, "Abakar", "Mahamat"), new StudentsModel(6, "Abakar", "Roushed"),
			new StudentsModel(7, "Abakar", "Tasnim"), new StudentsModel(8, "Frikh", "Amal"));
