...
//		loginButton.textProperty().bind(I18N.createStringBinding("login"));
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		assert languageChoiceBox != null
				: "fx:id=\"languageChoiceBox\" was not injected: check your FXML file 'login.fxml'.";
		assert username != null : "fx:id=\"username\" was not injected: check your FXML file 'login.fxml'.";
		assert password != null : "fx:id=\"password\" was not injected: check your FXML file 'login.fxml'.";
		assert passwordForgottenButton != null
				: "fx:id=\"passwordForgotten\" was not injected: check your FXML file 'login.fxml'.";
		assert loginButton != null : "fx:id=\"login\" was not injected: check your FXML file 'login.fxml'.";
		assert resetPasswordButton != null
				: "fx:id=\"resetPassword\" was not injected: check your FXML file 'login.fxml'.";
