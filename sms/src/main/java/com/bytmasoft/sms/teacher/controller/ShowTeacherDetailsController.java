...
@Log4j2
@Component
public class ShowTeacherDetailsController implements Initializable {
	...
	@Autowired
	ShowAllTeachersController showAllStudentsController;
...
//	}
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		stageManager.addShowTeacherController(this);
